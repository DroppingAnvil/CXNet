...
public class StatePersistenceTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            registerEvent.p = new dev.droppinganvil.v3.network.CXPath();
            ...
            registerEvent2.p = new dev.droppinganvil.v3.network.CXPath();
            ...
            unblockEvent.p = new dev.droppinganvil.v3.network.CXPath();
