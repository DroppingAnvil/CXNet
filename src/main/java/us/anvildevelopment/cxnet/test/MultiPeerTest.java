...
public class MultiPeerTest {
    ...
    private static void runBlockchainSyncAndPermissionTest(List<ConnectX> peers) throws Exception {
        ...
        System.out.println("  Peer 4 has permission: " + cxnet.checkChainPermission(PEER4_ID, Permission.Record.name(), c3ID));
        ...
        permissionGrant.put("permission", Permission.Record.name());
